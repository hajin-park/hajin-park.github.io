export default function Footer() {
    return (
        <section className='group relative'>
            ...
            <address id='footer' className='transition-all group-hover:-translate-x-1 group-hover:translate-y-1 group-active:-translate-x-2 group-active:translate-y-2 bg-pink-900 dark:bg-pink-200 h-20 w-full'>
