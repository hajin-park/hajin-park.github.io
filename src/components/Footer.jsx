export default function Footer() {
    return (
        <section className='group relative'>
            ...
            <div className='transition-all absolute -translate-x-4 translate-y-4 group-hover:translate-y-6 group-hover:-translate-x-6 -z-20 h-20 w-full bg-green-300 shadow-lg'>
            </div>
