export default function Backgrounds() {
    return (
        <>
            <div className="absolute w-full h-screen overflow-hidden bottom-0 clip-path-poly-right bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-rose-800  to-black "></div>
